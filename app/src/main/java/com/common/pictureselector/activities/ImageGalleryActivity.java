...
import com.common.pictureselector.utils.AppOperator;
import com.common.pictureselector.utils.PicturesCompressor;
import com.common.pictureselector.utils.StreamUtils;
import com.common.pictureselector.view.ImagePreviewView;
import com.common.pictureselector.view.PreviewerViewPager;
            ...
            public void run() {
                try {
                    ...
                    String extDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES)
                            .getAbsolutePath() + File.separator + "PicturesSelector";
